function [c,P, Q,l,vms,sigma_min,y2,y4,y7,q_g_deter] = VoltageStability_DF_Turitsyn_q_g(nbr,n,r,x,p_c,q_c,p_g,children,injection_matrix,parent,PV_matrix,PV_n,lambda,eps1,eps2,var,q_g_max)
cvx_begin quiet

variables  P(nbr) Q(nbr) l(nbr) vms(n) sigma_min q_g_deter(PV_n)  
...
c = r'*l + lambda*norm((vms-ones(n,1))/2,inf);
      minimize c
        ...
        y2 :      Q    == children*Q + diag(x)*l    +  injection_matrix*( var*eps2 + q_c - PV_matrix*q_g_deter ) %
